 ...
 * "Facts" page states aggregate metrics per batch and never a company's name, and neither its
 * home page nor its "Facts" page names a single company. Alchemist's portfolio page ships its
 * grid empty, with an HTML comment on the container reading "Items will be populated via
